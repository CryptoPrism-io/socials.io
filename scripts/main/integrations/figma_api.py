...
os.environ["OPENROUTER_API_KEY"] = os.getenv('OPENROUTER_API_KEY', "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") # Replace with your actual API key

# Note: This should be updated to use OpenRouter API instead of Together client
# For now, keeping as placeholder - recommend updating to requests-based approach
import requests
