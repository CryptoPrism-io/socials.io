...
async def generate_7_with_screenshot():
    """Generate Template 7 with screenshot"""
    print("📸 Generating Template 7 with screenshot...")
    ...
    try:
        ...
        print(f"❌ Template 7 screenshot error: {str(e)}")
        return False
...
if __name__ == "__main__":
    ...
    result = asyncio.run(generate_7_with_screenshot())

    if result:
        print("🎉 Template 7 generation completed successfully!")
    else:
        print("💥 Template 7 generation failed!")
        sys.exit(1)